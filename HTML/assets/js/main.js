...
$(function(){
	...
	*/
	...
	function initMap() {
  		...
  		var mapLatitude = -6.033665399999999 ; // Google map latitude 
  		var mapLongitude = 106.04207459999998 ; // Google map Longitude  
		...
		var infowindow = new google.maps.InfoWindow({content:'<strong>Rumah</strong><br>jalan kecubung 4, cilegon<br>'})
